...
public class EditCommunicationBookFrame extends JFrame implements CrossButtonListener, ActionListener
{
...
public EditCommunicationBookFrame()
{
initComponent();
setTitle("Edit Communication Book");
