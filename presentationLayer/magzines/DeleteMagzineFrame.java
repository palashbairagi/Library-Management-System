...
public class DeleteMagzineFrame extends JFrame implements CrossButtonListener,ActionListener
{
private JLabel idLabel;
private JTextField idTextField;
private JButton deleteButton;

public DeleteMagzineFrame()
{
initComponent();
setTitle("Delete Magzine");
...
try
{
referenceBookDL.delete(getId());
JOptionPane.showMessageDialog(this,"Magzine Deleted");
idTextField.setText("");
requestFocusOnId();
