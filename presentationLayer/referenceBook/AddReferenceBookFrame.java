...
public class AddReferenceBookFrame extends JFrame implements CrossButtonListener, ActionListener
{
...
public AddReferenceBookFrame()
{
initComponent();
setTitle("Add Reference Book");
...
private boolean addReferenceBook()
{
