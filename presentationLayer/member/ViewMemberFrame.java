...
public class ViewMemberFrame extends JFrame implements CrossButtonListener, ListSelectionListener
{
...
MemberInterface member=memberModel.get(selectedRowIndex);
setId(member.getId());
