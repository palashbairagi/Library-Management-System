...
public class FindByLastNameFrame extends JFrame implements CrossButtonListener, ListSelectionListener
{
...
private FindByLastNameModel findByLastNameModel;
private JTable memberTable;
private JScrollPane memberScrollPane;

public FindByLastNameFrame(String lastName)
{
initComponent(lastName);
setTitle("Member By Last Name");
...
private void initTable(String lastName)
{
findByLastNameModel=new FindByLastNameModel(lastName);
memberTable=new JTable(findByLastNameModel);
...
private void initComponent(String lastName)
{
initTable(lastName);
...
private void setMemberName(String firstName)
{
this.nameTextField.setText(firstName);
}
...
MemberInterface member=findByLastNameModel.get(selectedRowIndex);
setId(member.getId());
