...
public class FindBySubjectFrame extends JFrame implements CrossButtonListener, ListSelectionListener
{
...
private FindBySubjectModel findBySubjectModel;
private JScrollPane bookScrollPane;

public FindBySubjectFrame(String subject)
{
initComponent(subject);
setTitle("Book By Subject");
...
private void initTable(String subject)
{
findBySubjectModel=new FindBySubjectModel(subject);
bookTable=new JTable(findBySubjectModel);
...
private void initComponent(String subject)
{
initTable(subject);
...
BookInterface book=findBySubjectModel.get(selectedRowIndex);
setId(book.getId());
