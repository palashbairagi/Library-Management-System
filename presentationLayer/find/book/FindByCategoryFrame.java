...
public class FindByCategoryFrame extends JFrame implements CrossButtonListener, ListSelectionListener
{
...
private FindByCategoryModel findByCategoryModel;
private JScrollPane bookScrollPane;

public FindByCategoryFrame(String category)
{
initComponent(category);
setTitle("Book By Category");
...
private void initTable(String category)
{
findByCategoryModel=new FindByCategoryModel(category);
bookTable=new JTable(findByCategoryModel);
...
private void initComponent(String category)
{
initTable(category);
...
BookInterface book=findByCategoryModel.get(selectedRowIndex);
setId(book.getId());
